...
static void container_root(int a)
{
    ...
    if (a == 0)
    {
        printk("container 2 rootproc %d\n", create_container(container_root, 2)->rootproc->pid );
        printk("container 3 rootproc %d\n", create_container(container_root, 3)->rootproc->pid );
...
void container_test()
{
    ...
    stop = false;
    extern char loop_start[], loop_end[];
    printk("container 0 rootproc %d\n", create_container(container_root, 0)->rootproc->pid );
    printk("container 1 rootproc %d\n", create_container(container_root, 1)->rootproc->pid );
